...
Future<String?> showGeneralPostComposerSheet(
  ...
  return showModalBottomSheet<String>(
    ...
    builder:
        (_) => MultiBlocProvider(
          ...
          child: GeneralPostComposerSheet(
            audience: audience,
            createdBy: createdBy,
          ),
        ),
...
class GeneralPostComposerSheet extends StatefulWidget {
  final CreatePostFlowResult audience;
  final int createdBy;

  const GeneralPostComposerSheet({
    super.key,
  ...
  @override
  State<GeneralPostComposerSheet> createState() =>
      _GeneralPostComposerSheetState();
}

class _GeneralPostComposerSheetState extends State<GeneralPostComposerSheet> {
  ...
  void _submit() {
    ...
    context.read<CreateAnnouncementCubit>().createGeneralAnnouncement(
