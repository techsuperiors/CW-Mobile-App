...
class _RegularizeDetailPageState extends State<RegularizeDetailPage> {
  ...
  Widget _buildDetailsCard(
    ...
    final showsCheckIn =
        currentRequest.requestType == RegularizeRequestType.punchIn ||
        currentRequest.requestType == RegularizeRequestType.both;
    final showsCheckOut =
        currentRequest.requestType == RegularizeRequestType.punchOut ||
        currentRequest.requestType == RegularizeRequestType.both;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(height: screenHeight * 0.03, color: AppColors.border),
          if (showsCheckIn && currentRequest.checkIn != null) ...[
            _buildDetailRow(
              context,
              'Check-In:',
          ...
          if (showsCheckOut && currentRequest.checkOut != null) ...[
            _buildDetailRow(
              context,
              'Check-Out:',
          ...
          if (widget.isApprovalMode &&
            ...
            ApprovalActionBar(
              embedded: true,
              isLoading: state is RegularizeDetailStatusUpdating,
