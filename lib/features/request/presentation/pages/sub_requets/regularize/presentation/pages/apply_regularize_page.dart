...
class ApplyRegularizePage extends StatefulWidget {
  final RegularizeRequestModel? regularizeRequest; // Optional: for editing existing regularize
  final DateTime? selectedDate; // Optional: pre-fill attendance date

  const ApplyRegularizePage({super.key, this.regularizeRequest, this.selectedDate});
...
class _ApplyRegularizePageState extends State<ApplyRegularizePage> {
  ...
  void initState() {
    ...
    final remoteDataSource = AttendanceRegularizeRemoteDataSourceImpl(apiClient);
  ...
  void _initializeFormFromRegularizeRequest(RegularizeRequestModel regularizeRequest) {
    _attendanceDate = regularizeRequest.fromDate;
    _requestType = regularizeRequest.requestType;
    _descriptionController.text = regularizeRequest.reason;
  }
  ...
  Future<void> _selectTime(BuildContext context, bool isPunchIn) async {
    final TimeOfDay initialTime = isPunchIn
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    widget.regularizeRequest != null ? 'Edit Regularize Request' : AppStrings.regularize,
              ...
              SizedBox(height: screenHeight * 0.02),
              // Reason - Text field instead of dropdown
              AppTextField(
                label: 'Reason',
                hint: 'Enter Reason',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isSubmitting
                      ...
                      : Text(
                          widget.regularizeRequest != null ? 'Update' : 'Submit',
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isSelected ? AppColors.attendanceTeal : Colors.transparent,
              ),
              child: isSelected
                  ? Icon(
                      Icons.check,
            ...
            Expanded(
              child: Text(
                label,
                style: AppTextStyles.bodyMedium(context).copyWith(
                  color: isSelected ? AppColors.attendanceTeal : AppColors.textPrimary,
