...
import '../widgets/visit_location_capture_dialog.dart';
    ...
    return BlocProvider(
      create:
          (_) => VisitBloc(
            ...
            getVisitDetailsUseCase: GetVisitDetailsUseCase(repository),
            getVisitActivityDetailsUseCase:
                GetVisitActivityDetailsUseCase(repository),
            createVisitUseCase: CreateVisitUseCase(repository),
            createVisitActivityUseCase: CreateVisitActivityUseCase(repository),
            updateVisitActivityUseCase: UpdateVisitActivityUseCase(repository),
            startVisitActivityUseCase: StartVisitActivityUseCase(repository),
            completeVisitActivityUseCase:
                CompleteVisitActivityUseCase(repository),
            deleteVisitActivityUseCase: DeleteVisitActivityUseCase(repository),
...
class _VisitManagementPageState extends State<VisitManagementPage>
  ...
  Future<void> _openVisitDetails(VisitModel visit) async {
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder:
            (_) => BlocProvider.value(
              value: context.read<VisitBloc>(),
              child: VisitDetailPage(visitId: visit.id),
            ),
      ),
    );
  }

  Future<void> _handleStartedStatusTap(VisitModel visit) async {
    ...
    await showDialog<void>(
      ...
      builder: (_) => const VisitLocationCaptureDialog(),
    );
