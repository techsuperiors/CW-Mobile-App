...
class PlannedVisitActivityCard extends StatelessWidget {
  ...
  const PlannedVisitActivityCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final addressLine = _addressLine;
              ...
              _InfoIconRow(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: customerName.isNotEmpty ? 'Client - ' : 'Type - ',
                      ),
                      TextSpan(
                        text:
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      onPressed: isStarting ? null : onStartActivity,
  ...
  String get _scheduledTimeRange {
    final start = _formatDisplayTime(activity.estimatedTime) ?? '--';
  ...
  String? get _scheduledExitTime {
    final scheduledTime = activity.estimatedTime;
    final scheduledDuration = activity.estimatedDuration;
