/// Application assets (images, icons, etc.)
class AppAssets {
  // Logo
  ...
  // Event Emojis (using text for now, can be replaced with images)
  static const String emojiBirthday = '🎂';
  static const String emojiAnniversary = '🎁';
  static const String emojiHoliday = '🎉';

  // Attendance Icons
  static const String iconPunchIn = 'assets/icons/punch_in_icon.svg';
